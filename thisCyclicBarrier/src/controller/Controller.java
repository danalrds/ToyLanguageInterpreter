...
public class Controller {
    ...
    public void createProgramState(Statement statement) {
        ...
        BarrierTable<Integer,Pair<List<Integer>,Integer>> barrierTable=new BarrierTable<Integer, Pair<List<Integer>, Integer>>();
        int id = IdGenerator.generateId();
        ProgramState state = new ProgramState(stack, dict, list, fileTable, heap,barrierTable, id);
