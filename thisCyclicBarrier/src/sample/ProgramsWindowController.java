...
public class ProgramsWindowController {
    ...
    private List<Statement> getProgramsList() {
        ...
        Statement firstul = new CompoundStatement(
                new AssignStatement("v", new ConstantExpression(0)),
                new WhileStatement(
                        new BooleanExpression(new VarExpression("v"), new ConstantExpression(3), "<"),
                        new CompoundStatement(
        ...
        Statement secondul = new CompoundStatement(
                new SleepStatement(15),
                new PrintStatement(
                        new ArithmeticExpression('*', new VarExpression("v"), new ConstantExpression(10))
                )
        );
        Statement ex6 = new CompoundStatement(firstul, secondul);
        list.add(ex1);
        Statement part1 = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new NewBarrierStatement("cnt", new HeapReading("v3"))
                        )
                )
        );
        Statement part2 = new CompoundStatement(
                new ForkStatement(
                        new CompoundStatement(
                                new HeapWriting("v1",
        ...
        Statement part3=new CompoundStatement(
                new AwaitStatement("cnt"),
                new PrintStatement(new ConstantExpression(2000))
        );
