...
public class LayoutController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> lockIndexColumn;
    ...
    public LayoutController() {
        ...
        Repository repo1 = new RepositoryImpl("D:\\Intellij\\thisCopy1\\src\\states1.txt");
    ...
    private void populateLockTable() {
        ...
        if (this.controller.getRepository().getProgramList().size() > 0) {
            AbstractDictionary<Integer, Integer> thisLockTable = this.controller.getRepository().getProgramList().get(0).getLockTable();
            lockTable.getItems().clear();
            lockTable.getItems().addAll(
                    thisLockTable.entrySet()
                            .stream()
                            //.peek(x -> System.out.println(x + " in tha table*********************************************************"))
